...
import type { PaverDetails, Sku } from '~/types/product';
...
function PaverEstimator({ paverDetails, sku }: PaverEstimatorProps) {
	...
	return (
		<section
			data-ai-hidden
			className="space-y-4 rounded-sm border border-gray-300 bg-gray-200 p-6 text-gray-900 lg:px-8"
		>
			...
			<div className="flex items-end">
				<output htmlFor="paver-estimator" className="flex-1 space-y-1">
