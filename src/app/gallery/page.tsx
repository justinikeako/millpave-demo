...
import * as Dialog from '@/components/d';
...
export const metadata = {
	title: 'Inspiration Gallery — Millennium Paving Stones'
};
...
function GalleryFilter({ children, category, selected }: GalleryFilterProps) {
	return (
...
function Page({ searchParams }: PageProps) {
	...
	if (!categoryId) {
		redirect('/gallery?category=walkway');
	}
										...
										<div className="h-fit space-y-16 px-8 py-16 md:flex-1 md:px-12 lg:px-16">
											<section>
												...
												<p>
													...
													temporibus nesciunt pariatur harum quisquam voluptatum
													dicta facilis ut similique minus, soluta at
													consectetur ipsa corporis eos doloribus atque tempora
													molestias voluptatibus. Magni esse nihil debitis
