		...
		compoundVariants: [
			{
				...
				className: [
					...
					// Focused
					'hover:before:opacity-60 hover:after:opacity-60 group-hover:before:opacity-60 group-hover:after:opacity-60 group-focus-within:before:opacity-60 group-focus-within:after:opacity-60',
					// Active
			...
			},
			{
				...
				className: [
					...
					// Focused
					'hover:before:opacity-100 hover:after:opacity-100 group-hover:before:opacity-100 group-hover:after:opacity-100 group-focus-within:before:opacity-100 group-focus-within:after:opacity-100',
					// Active
			...
			},
			{
				...
				backdrop: 'light',
				className:
					'border-gray-900/25 hover:bg-gray-900/5 group-hover:bg-gray-900/5 group-focus-within:bg-gray-900/5 active:!bg-gray-900/10'
			},
			{
				intent: 'secondary',
				backdrop: 'dark',
				className:
					'text-gray-100 border-gray-100/25 hover:bg-gray-100/5 group-hover:bg-gray-100/5 group-focus-within:bg-gray-100/5 active:!bg-gray-100/10'
			},
			{
				intent: 'tertiary',
				backdrop: 'light',
